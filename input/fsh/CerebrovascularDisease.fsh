...
ValueSet: MyHealthWayCardioCerebrovascularDisease
Id: myhealthway-cv-cerebrovasculardisease
...
* include codes from system SNOMED_CT_INT where concept is-a #62914000