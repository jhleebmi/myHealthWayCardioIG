...
ValueSet: MyHealthWayCardioSmokingStatus
Id: myhealthway-cv-smokingstatus
Title: "Smoking Status"
Description: """* ^experimental = true
...
* include codes from system SNOMED_CT_INT where concept is-a #365980008