...
ValueSet: MyHealthWayCardioChronicLungDisease
Id: myhealthway-cv-chroniclungdisease
...
* include codes from system SNOMED_CT_INT where concept is-a #413839001
* LOINC#54822-2
* exclude codes from system SNOMED_CT_INT where concept is-a #40122008
* exclude SNOMED_CT_INT#123713005
* exclude SNOMED_CT_INT#22607003
* exclude SNOMED_CT_INT#254826008
* exclude SNOMED_CT_INT#29422001